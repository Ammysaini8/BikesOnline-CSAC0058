 ...
 <a class="active" href="Home.aspx">Home</a>
  <a href="BrandList.aspx">Brand</a>
        ...
        <div class="auto-style3">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CssClass="auto-style11" ForeColor="White">
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
            <asp:Image ID="Image2" runat="server" ImageUrl="~/image/H.jpg"   CssClass="auto-style10" />
            <br />
            <br />
        </div>
    </form>
